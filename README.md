...
Provide a single portal for students.
Allow students to register and log in.
Display college events and notices.
Allow students to register for events.
Allow students to manage their profiles.
Provide an administrative management system.
3. User Roles
3.1 Student
The student can:
